...
import { ArrowRight, Globe, Rocket, Target, Users, Zap } from "lucide-react";
  ...
  const features = [
    {
      ...
      description:
        "Swipe right on projects that ignite your passion. No complex applications, just instant connection.",
      color: "text-primary",
    },
    {
      icon: Globe,
      ...
      description:
        "Connect with brilliant minds across campus and beyond. Build teams that scale with your vision.",
    ...
    },
    {
      ...
      title: "Focused Goals",
      description:
        "Find teammates who share your technical stack and ambition. Get stuff done faster and better.",
      color: "text-accent",
    },
  ];
    ...
    <div className="min-h-screen relative bg-black text-white overflow-x-hidden">
      ...
      <section className="pt-40 pb-20 px-6">
        <div className="max-w-5xl mx-auto text-center relative">
          ...
          >
            The premium networking platform for undergrads. Swipe through projects, connect with
            teammates, and build the future together.
          </motion.p>
            ...
            {features.map((feature, i) => {
              ...
              return (
                ...
                >
                  <div
                    className={
                      "w-14 h-14 rounded-2xl mb-6 flex items-center justify-center bg-white/5 group-hover:scale-110 transition-transform"
                    }
                  >
      ...
      <section className="py-20 px-6 relative">
        <div className="max-w-4xl mx-auto glass-morphism p-12 rounded-[3rem] text-center border-white/5 overflow-hidden">
          ...
          <h2 className="text-4xl font-black mb-6">
            Built by Undergrads, <br /> For Undergrads
          </h2>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <div className="px-6 py-2 glass-morphism rounded-full text-sm font-bold border-white/10">
              3,000+ Students
            </div>
            <div className="px-6 py-2 glass-morphism rounded-full text-sm font-bold border-white/10">
              500+ Projects
